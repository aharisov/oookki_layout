<section class="basket-block abon-block">
    <h3>Êtes-vous abonné OOOKKI ?</h3>
    <p>Connectez-vous pour profiter d'une remise et gagner du temps à la souscription.</p>
    <button class="link open-modal" data-modal="abon-advants-modal">En savoir plus</button>
    ...
    <div class="config-options accordion-container">
        ...
        <div class="config-option accordion-item">
            <div class="switch accordion-head">
                ...
                <i class="note promo">Jusqu'à -10€/mois sur le Forfait Extrems OOOKKI</i>
            </div>
