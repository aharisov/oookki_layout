<div id="price-details-modal" class="modal from-right price-details-modal">
    ...
    <div class="modal-inner">
        ...
        <div class="price-details">
            <div class="block">
                <div class="line line-sum">
                    <div class="left">Prix du téléviseur</div>
                    <div class="right">= 1149 €</div>
                </div>
            </div>
            <div class="block">
                <div class="line">
        ...
        <div class="credit-note">
            ...
            <p>Intérêts : 125.86€ / Taux annuel effectif global (TAEG) fixe : 9.69% / Taux débiteur fixe : 9.28%</p>
