<form id="register-form" class="signup-form auth-form" method="post">
    <div class="form-title">
        <i class="fa-solid fa-id-card"></i>
        <h1>Créez votre compte OOOKKI</h1>
    </div>
    <p class="top-note">Vous avez déjà un compte ? <a href="login.php" class="link">Connectez-vous</a> !</p>
    ...
    <div class="form-line">
        ...
        <input id="field-firstname" name="firstname" type="text" value="" required="">
