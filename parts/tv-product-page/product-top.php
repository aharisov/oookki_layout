<div class="product-top">
    ...
    <div class="product-top__inner flex">
        <div class="product-top__name">TV AI OLED 55" S90D 2024, 4K</div>
        ...
        <div class="product-top__price flex">
            <div class="info">
                <span class="info-sum">1195 €</span>
                <i class="info-note">ou 125€/mois</i>
            </div>
            <div class="buttons flex">
                ...
                <button type="button" class="btn btn-red  open-modal add-to-cart" 
                    ...
                    data-title='Samsung TV AI OLED 55\" S90D 2024, 4K'
