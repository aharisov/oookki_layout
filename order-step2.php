        ...
        <div class="cont">
            <form class="order-wrap flex" method="post">
                <div class="order-content personal-content">
                    <?php include("./parts/order/personal/personal-info.php")?>
                    <?php include("./parts/order/personal/personal-address.php")?>
                    <?php include("./parts/order/personal/personal-prefrences.php")?>
                    <?php include("./parts/order/step2-buttons.php")?>
